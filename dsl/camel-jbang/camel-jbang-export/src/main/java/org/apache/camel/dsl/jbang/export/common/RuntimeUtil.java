    ...
    public static void configureLog(
        ...
        if (INIT_DONE.compareAndSet(false, true)) {
            ...
            if (loggingConfigPath != null) {
                ...
                // keep in sync with CommandLineHelper.CAMEL_JBANG_WORK_DIR in camel-jbang-core,
                // which cannot be referenced from here without a dependency back on the CLI module
